  ...
  <br><br>
    <div class="containerPaketUmroh row justify-content-center">
      <div class="paketUmroh">
        <?php
        $i = 1;
        $rows = mysqli_query($conn, "SELECT * FROM hajiKhusus WHERE id = 1"); ?>
        <?php foreach ($rows as $row) : ?>
          <tr>
            ...
            <?php
            echo
            "<td><a href='paketHajiKhusus.php?id=" . $row['id'] . "' class='button33'>Selengkapnya</a> </td>" ?>
          </tr>
        <?php endforeach; ?>
      </div>
      ...
      <div class="paketUmroh">
        <?php
        $i = 1;
        $rows = mysqli_query($conn, "SELECT * FROM hajiKhusus WHERE id = 2"); ?>
        <?php foreach ($rows as $row) : ?>
          <tr>
            <td>
              <!-- <h1><?php echo $row["nama"]; ?></h1> -->
      ...
      <div class="paketUmroh">
        <?php
        $i = 1;
        $rows = mysqli_query($conn, "SELECT * FROM hajiKhusus WHERE id = 4"); ?>
        <?php foreach ($rows as $row) : ?>
          <tr>
            <td>
              <!-- <h1><?php echo $row["nama"]; ?></h1> -->
      ...
      <div class="paketUmroh">
        <?php
        $i = 1;
        $rows = mysqli_query($conn, "SELECT * FROM hajiKhusus WHERE id = 5"); ?>
        <?php foreach ($rows as $row) : ?>
          <tr>
            <td>
              <!-- <h1><?php echo $row["nama"]; ?></h1> -->
      ...
      <div class="paketUmroh">
        <?php
        $i = 1;
        $rows = mysqli_query($conn, "SELECT * FROM hajiKhusus WHERE id = 6"); ?>
        <?php foreach ($rows as $row) : ?>
          <tr>
            <td>
              <!-- <h1><?php echo $row["nama"]; ?></h1> -->
