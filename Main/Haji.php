  ...
  <div class="containerUmroh">
    ...
    <div class="containerPaketUmroh">
      ...
      <div class="paketUmroh">
        <?php
        $i = 1;
        $rows = mysqli_query($conn, "SELECT * FROM haji WHERE id = 7"); ?>
        <?php foreach ($rows as $row) : ?>
          <tr>
            <td>
              <h1><?php echo $row["nama"]; ?></h1>
      ...
      <div class="paketUmroh">
        <?php
        $i = 1;
        $rows = mysqli_query($conn, "SELECT * FROM haji WHERE id = 8"); ?>
        <?php foreach ($rows as $row) : ?>
          <tr>
            <td>
              <h1><?php echo $row["nama"]; ?></h1>
      ...
      <div class="paketUmroh">
        <?php
        $i = 1;
        $rows = mysqli_query($conn, "SELECT * FROM haji WHERE id = 9"); ?>
        <?php foreach ($rows as $row) : ?>
          <tr>
            <td>
              <h1><?php echo $row["nama"]; ?></h1>
      ...
      <div class="paketUmroh">
        <?php
        $i = 1;
        $rows = mysqli_query($conn, "SELECT * FROM haji WHERE id = 10"); ?>
        <?php foreach ($rows as $row) : ?>
          <tr>
            <td>
              <h1><?php echo $row["nama"]; ?></h1>
