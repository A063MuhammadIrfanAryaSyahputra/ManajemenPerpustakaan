    ...
    <div class="footer-container">
        <div class="footer-section" style="text-align: left;">
            ...
            <div class="footer-logo" style="flex: 1; display: flex; align-items: center;">
                ...
                <div class="logo-description" style="margin-left: 10px;">
                    <p style="margin-bottom: 10px; font-style: italic; font-size: 16px; color: #E0B64A;">amansatourstravel@gmail.com</p>
                </div>
            </div>
        ...
        <div class="footer-section">
            ...
            <a href="../Admin/loginPage/" class="sidebar-link" style="color: #E0B64A; text-decoration: none; text-align: left; display: block; margin-top: 10px;">> Login</a>
        </div>
    </div>
    </div>
