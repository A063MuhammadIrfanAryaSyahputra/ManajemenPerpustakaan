<footer>
    <div class="footer-container">
        <div class="footer-section" style="text-align: left;">
            <div class="footer-logo" style="flex: 1; display: flex; align-items: center;">
            ...
            <div class="footer-logo" style="flex: 1; display: flex; align-items: center;">
                <!-- <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#E0B64A" class="bi bi-telephone" viewBox="0 0 20 20" style="flex-shrink: 0;">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#E0B64A" class="bi bi-whatsapp" viewBox="0 0 20 20" style="flex-shrink: 0;">
                ...
                <div class="logo-description" style="margin-left: 10px;">
                    <p style="margin-bottom: 10px; font-style: italic; font-size: 16px; color: #E0B64A;">0822 2020 8300</p>
                </div>
            </div>

            <div class="footer-logo" style="flex: 1; display: flex; align-items: center;">

                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#E0B64A" class="bi bi-envelope" viewBox="0 0 20 20" style="flex-shrink: 0;">
                    <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16" />
                    <path d="M5.255 5.786a.237.237 0 0 0 .241.247h.825c.138 0 .248-.113.266-.25.09-.656.54-1.134 1.342-1.134.686 0 1.314.343 1.314 1.168 0 .635-.374.927-.965 1.371-.673.489-1.206 1.06-1.168 1.987l.003.217a.25.25 0 0 0 .25.246h.811a.25.25 0 0 0 .25-.25v-.105c0-.718.273-.927 1.01-1.486.609-.463 1.244-.977 1.244-2.056 0-1.511-1.276-2.241-2.673-2.241-1.267 0-2.655.59-2.75 2.286m1.557 5.763c0 .533.425.927 1.01.927.609 0 1.028-.394 1.028-.927 0-.552-.42-.94-1.029-.94-.584 0-1.009.388-1.009.94" />
                </svg>
                <div class="logo-description" style="margin-left: 20px;">
                    ...
                    <a href="main/questionForm.php" style="margin-bottom: 10px; font-style: italic; font-size: 16px; color: #E0B64A;">Ada Pertanyaan?</a>
