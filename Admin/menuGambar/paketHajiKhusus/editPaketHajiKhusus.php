...
<html lang="en" data-bs-theme="dark">
  <head>
    ...
    <title>Dashboard Admin - Edit HajiKhusus</title>
          ...
          <div class="container-fluid">
            ...
            <div class="card border-0">
              <div class="card-header">
                ...
                <h6 class="card-subtitle text-muted">Tambah Data Paket Haji Khusus Dibawah ini</h6>
              </div>
              <div class="card-body">
                <h2 class="mb-3">Edit Image</h2>
                <form action="updatePaketHajiKhusus.php" method="POST" enctype="multipart/form-data">
