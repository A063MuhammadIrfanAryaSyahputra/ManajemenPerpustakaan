...
<head>
  ...
  <title>Dashboard Admin - Haji</title>
    ...
    <div class="main">
      ...
      <main class="content px-3 py-2">
        <div class="container-fluid">
          <div class="mb-3">
            <h4>List Gambar - Paket Haji Khusus</h4>
          </div>
          ...
          <div class="card border-0">
            <div class="card-header">
              ...
              <h6 class="card-subtitle text-muted">Dibawah ini adalah list gambar yang ada pada menu paket haji</h6>
            </div>
            <div class="card-body">
              <table class="table">
                <tr>
